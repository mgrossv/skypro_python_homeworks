...
class API:
    ...
    def get_token(self, user='leyla', password='water-fairy'):
        creds = {
           'username': user,
           'password': password
           }
    ...
    def create_employee(self, firstName, lastName, middleName,
                        companyId, email, url, phone, birthdate, isActive):
        employee = {
            "firstName": firstName,
            "lastName": lastName,
    ...
    def edit_employee(self, id, new_lastName, new_email, new_url, new_phone,
                      new_isActive):
        employee = {
